...
public class CompilePineToDotNetTests
{
    ...
    {
        new ExprMappedToParentEnv.PathInParentEnv([]).Should().Be(new ExprMappedToParentEnv.PathInParentEnv([]));

        new ExprMappedToParentEnv.PathInParentEnv([1, 3]).Should().Be(new ExprMappedToParentEnv.PathInParentEnv([1, 3]));
    }
